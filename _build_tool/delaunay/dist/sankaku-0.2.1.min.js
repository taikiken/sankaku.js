...
(function(h){h.Sankaku.Iro=function(){function g(){throw Error("Iro can't create instance");}g.rgb2hsl=function(f,e,d){f/=255;e/=255;d/=255;var c=Math.max(f,e,d),b=Math.min(f,e,d),a,k,q;k=(c+b)/2;if(c===b)a=b=0;else{q=c-b;b=0.5<k?q/(2-c-b):q/(c+b);switch(c){case f:a=(e-d)/q+(e<d?6:0);break;case e:a=(d-f)/q+2;break;case d:a=(f-e)/q+4}a/=6}return{h:a,s:b,l:k}};g.hsl2rgb=function(f,e,d){function c(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+(b-a)*(2/3-c)*6:a}if(0===e)d=e=
f=d;else{var b=0.5>d?d*(1+e):d+e-d*e,a=2*d-b;d=c(a,b,f+1/3);e=c(a,b,f);f=c(a,b,f-1/3)}return{r:255*d,g:255*e,b:255*f}};g.rgb2hsv=function(f,e,d){f/=255;e/=255;d/=255;var c=Math.max(f,e,d),b=Math.min(f,e,d),a,k=c-b;if(c===b)a=0;else{switch(c){case f:a=(e-d)/k+(e<d?6:0);break;case e:a=(d-f)/k+2;break;case d:a=(f-e)/k+4}a/=6}return{h:a,s:0===c?0:k/c,v:c}};g.hsv2rgb=function(f,e,d){var c,b,a,k=Math.floor(6*f),q=6*f-k;f=d*(1-e);var n=d*(1-q*e);e=d*(1-(1-q)*e);switch(k%6){case 0:c=d;b=e;a=f;break;case 1:c=
...
(function(h){h.Sankaku.List=function(){function g(){throw Error("List can't create instance");}var f=Math.random,e=Math.floor,d=Math.max;g.word=function(c,b){var a=[],k;for(k=0;k<c;k++)a[k]=b;return a};g.zero=function(c){return this.word(c,0)};g.shuffle=function(c){for(var b=[],a=c.length,k;a;)k=e(f()*c.length),k in c&&(b.push(c[k]),delete c[k],--a);return b};g.max=function(c){return d.apply(null,c)};return g}()})(window);
...
(function(h){h.Sankaku.Distribute=function(){function g(){throw Error("Distribute can't create instance");}var f=Math.sqrt,e=Math.sin,d=Math.cos,c=Math.random,b=2*Math.PI;g.circle=function(a,k,q){var n;a*=f(c());n=c()*b;return{x:0.5*k+d(n)*a,y:0.5*q+e(n)*a}};return g}()})(window);
(function(h){var g=Math.abs,f=Math.min,e=Math.max,d=Math.round;h.Sankaku.Triangle=function(){function c(a,k,b){this.a=a;this.b=k;this.c=b;var c=k.x-a.x,d=k.y-a.y,m=b.x-a.x,v=b.y-a.y,h=c*(a.x+k.x)+d*(a.y+k.y),s=m*(a.x+b.x)+v*(a.y+b.y),p=2*(c*(b.y-k.y)-d*(b.x-k.x));1E-6>g(p)?(m=f(a.x,k.x,b.x),h=f(a.y,k.y,b.y),c=0.5*(e(a.x,k.x,b.x)-m),a=0.5*(e(a.y,k.y,b.y)-h),this.x=m+c,this.y=h+a):(k=(v*h-d*s)/p,b=(c*s-m*h)/p,c=k-a.x,a=b-a.y,this.x=k,this.y=b);this.r=c*c+a*a}var b=c.prototype;b.constructor=c;b.draw=
function(a){var k=this.a,b=this.b,c=this.c;a.beginPath();a.moveTo(k.x,k.y);a.lineTo(b.x,b.y);a.lineTo(c.x,c.y);a.closePath()};b.centroid=function(){return{x:d((this.a.x+this.b.x+this.c.x)/3),y:d((this.a.y+this.b.y+this.c.y)/3)}};return c}()})(window);
(function(h){h=h.Sankaku;var g=h.Triangle;h.Delaunay=function(){function f(){throw Error("Sankaku can't create instance.");}f.triangulate=function(e){if(3>e.length)return[];var d,c,b,a,k,f,n,l,m,h=function(a){var b=a.length,k,c,m,d,e;a:for(;b;)for(c=a[--b],k=a[--b],m=b;m;)if(e=a[--m],d=a[--m],k===d&&c===e||k===e&&c===d){a.splice(b,2);a.splice(m,2);b-=2;continue a}};e.sort(function(a,b){return b.x-a.x});c=e.length-1;d=e[c];b=d.x;a=e[0].x;for(f=k=d.y;c--;)d.y<k&&(k=d.y),d.y>f&&(f=d.y);n=a-b;l=f-k;c=
n>l?n:l;d=0.5*(a+b);n=0.5*(f+k);f=[new g({x:d-20*c,y:n-c,__sentinel:!0},{x:d,y:n+20*c,__sentinel:!0},{x:d+20*c,y:n-c,__sentinel:!0})];k=[];b=[];for(c=e.length;c--;){b.length=0;a=f.length;for(d=e[c];a--;)m=f[a],n=d.x-m.x,0<n&&n*n>m.r?(k.push(m),f.splice(a,1)):(l=d.y-m.y,n*n+l*l>m.r||(b.push(m.a,m.b,m.b,m.c,m.c,m.a),f.splice(a,1)));h(b);for(a=b.length;a;)l=b[--a],n=b[--a],f.push(new g(n,l,d))}Array.prototype.push.apply(k,f);for(c=k.length;c--;)e=k[c],(e.a.__sentinel||e.b.__sentinel||e.c.__sentinel)&&
k.splice(c,1);return k};return f}()})(window);
(function(h){h.Sankaku.Vector2D=function(){function g(a,b){this.x=a||0;this.y=b||0}var f=Math.floor,e=Math.ceil,d=Math.round,c=Math.cos,b=Math.sin,a=Math.atan2,k=Math.sqrt,q=Math.min,n=Math.acos,l=g.prototype;l.constructor=g;l.draw=function(a){a.beginPath();a.moveTo(0,0);a.lineTo(this.x,this.y);a.closePath();return this};l.clone=function(){return new g(this.x,this.y)};l.zero=function(){this.y=this.x=0;return this};l.isZero=function(){return 0===this.x&&0===this.y};l.set=function(a,b){this.x=a;this.y=
b;return this};l.setX=function(a){this.x=a;return this};l.setY=function(a){this.y=a;return this};l.copy=function(a){this.x=a.x;this.y=a.y;return this};l.add=function(a){this.x+=a.x;this.y+=a.y;return this};l.addScalar=function(a){this.x+=a;this.y+=a;return this};l.addNew=function(a){return new g(this.x+a.x,this.y+a.y)};l.addVector=function(a,b){this.x=a.x+b.x;this.y=a.y+b.y;return this};l.sub=function(a){this.x-=a.x;this.y-=a.y;return this};l.subNew=function(a){return new g(this.x-a.x,this.y-a.y)};
...
a.x);this.y>a.y&&(this.y=a.y);return this};l.max=function(a){this.x<a.x&&(this.x=a.x);this.y<a.y&&(this.y=a.y);return this};l.clamp=function(a,b){this.min(a);this.max(b);return this};l.clampScalar=function(a,b){var k,c;k=new g;c=new g;k.set(a,a);c.set(b,b);return this.clamp(k,c)};l.floor=function(){this.x=f(this.x);this.y=f(this.y);return this};l.ceil=function(){this.x=e(this.x);this.y=e(this.y);return this};l.round=function(){this.x=d(this.x);this.y=d(this.y);return this};l.roundToZero=function(){this.x=
0>this.x?e(this.x):f(this.x);this.y=0>this.y?e(this.y):f(this.y);return this};l.negate=function(){return this.multiplyScalar(-1)};l.dot=function(a){return this.x*a.x+this.y*a.y};l.lengthSq=function(){return this.x*this.x+this.y*this.y};l.length=function(){return k(this.lengthSq())};l.setLength=function(a){var b=this.length();0!==b&&a!==b&&this.multiplyScalar(a/b);return this};l.setAngle=function(a){var k=this.length(),k=k||0.001;this.x=c(a)*k;this.y=b(a)*k;return this};l.angle=function(){return a(this.y,
this.x)};l.normalize=function(){return this.divideScalar(this.length())};l.distanceSq=function(a){var b=this.x-a.x;a=this.y-a.y;return b*b+a*a};l.distance=function(a){return k(this.distanceSq(a))};l.lerp=function(a,b){this.x+=(a.x-this.x)*b;this.y+=(a.y-this.y)*b;return this};l.equals=function(a){return a.x===this.x&&a.y===this.y};l.fromArray=function(a){this.x=a[0];this.y=a[1];return this};l.toArray=function(){return[this.x,this.y]};l.truncate=function(a){a=q(a,this.length());return this.setLength(a)};
l.reverse=function(){this.negate();return this};l.isNormalize=function(){return 1===this.length()};l.perpendicular=function(){return new g(-this.y,this.x)};l.sign=function(a){return 0>this.perpendicular().dot(a)?-1:1};g.angleBetween=function(a,b){a.isNormalize()||(a=a.clone().normalize());b.isNormalize()||(b=b.clone().normalize());return n(a.dot(b))};return g}()})(window);
(function(h){var g=h.Sankaku,f=g.Vector2D,e=g.Num;g.Object2D=function(){function d(){this._position=new f;this.rotation=this.y=this.x=0;this.width=20;this.height=10;this.scale=1;this.parent=this.scene=null;this.children=[]}var c=Math.cos,b=Math.sin,a=d.prototype;a.constructor=d;g.EventDispatcher.initialize(a);a.position=function(a){this._position=a;this.x=a.x;this.y=a.y};a.getPosition=function(){return this._position};a.setX=function(a){this.x=a;this._position.x=a};a.setY=function(a){this.y=a;this._position.y=
a};a.bounding=function(){var a=this.x,d=this.y,e=this.width*this.scale*0.5,f=this.height*this.scale*0.5,g=this.rotation,h,r,s,p,t,u;s=b(g);p=c(g);h=-e;r=-f;g=p*h;t=p*r;r*=s;h*=s;u=p*e;p*=f;e*=s;f*=s;return{a:{x:g-r+a,y:t+h+d},b:{x:u-r+a,y:t+e+d},c:{x:u-f+a,y:p+e+d},d:{x:g-f+a,y:p+h+d}}};a.rotate=function(a){this.rotation=e.deg2rad(a)};a.clone=function(){return this._clone()};a._clone=function(){var a=new d;a.position(this._position.clone());a.width=this.width;a.height=this.height;a.rotation=this.rotation;
a.scale=this.scale;a.parent=parent&&parent.clone();return a};a.inside=function(a){function b(a,c,k){return k.x*c.y-c.x*k.y-(k.x*a.y-a.x*k.y)+(c.x*a.y-a.x*c.y)}var c=this.bounding();return 0<b(c.a,a)||0<b(c.b,a)||0<b(c.c,a)?!1:!0};a.add=function(a){if(a!==this){a.parent&&a.parent.remove(a);a.parent=this;this.children.push(a);var b=this.scene;b&&b._addChild(a)}};a.remove=function(a){var b;b=this.children.indexOf(a);-1!==b&&(a.parent=null,this.children.splice(b,1),(b=this.scene)&&b._removeChild(a))};
a.draw=function(a){this._draw(a);var b=this.children,c,d;c=0;for(d=b.length;c<d;c++)b[c].draw(a)};a._draw=function(a){};return d}()})(window);
(function(h){var g=h.Sankaku,f=g.Object2D,e=g.Vector2D,d=g.Iro;g.Shape=function(){function c(a,b,d,e,g,h){f.call(this);this.setX(a);this.setY(b);this.width=d||20;this.height=e||10;this._fill=h||c.STROKE;this._alpha=this._line=1;this._rgb={};this._color=g||"#000000";this.setColor(this._color);this.border(this.setLine,this._color)}g.extend(f,c);c.FILL="shape_fill";c.STROKE="shape_stroke";c.BOTH="shape_both";var b=c.prototype;b.constructor=c;b.radius=function(){var a=this.bounding(),b=a.a,a=a.c;return(new e(b.x,
b.y)).distance(new e(a.x,a.y))};b.clone=function(){var a=new c(this.x,this.y,this.width,this.height,this._color,this._fill);a.rotation=this.rotation;a.scale=this.scale;a._alpha=this._alpha;a._rgb=Object.create(this._rgb);a._line=this._line;a._border={setLine:this._border.setLine,rgb:this._border.rgb};return a};b.border=function(a,b){var c=d.hex2rgb(b);c.a=this._alpha;this._border={setLine:a,rgb:c};return this};b.setColor=function(a){this._color=a;this._rgb=d.hex2rgb(a);this._rgb.a=this._alpha;return this};
b.setAlpha=function(a){this._alpha=a;return this.setColor(this._color)};b.setMode=function(a){this._fill=a;return this};b.mode=function(){return this._fill};b.setLine=function(a){this._line=a;return this};b.line=function(){return this._line};b._draw=function(a){switch(this._fill){case c.STROKE:this.stroke(a,this._line,this._rgb);break;case c.FILL:this.fill(a,this._rgb);break;case c.BOTH:this.stroke(a,this._border._line,this._border._rgb),this.fill(a,this._rgb)}};b.fill=function(a,b){a.fillStyle="rgba("+
b.r+","+b.g+","+b.b+","+b.a+")";this.paint(a);a.fill()};b.stroke=function(a,b,c){a.lineWidth=b;a.strokeStyle="rgba("+c.r+","+c.g+","+c.b+","+c.a+")";this.paint(a);a.stroke()};b.paint=function(a){var b=this.bounding(),c=b.a,d=b.b,e=b.c,b=b.d;a.beginPath();a.moveTo(c.x,c.y);a.lineTo(d.x,d.y);a.lineTo(e.x,e.y);a.lineTo(b.x,b.y);a.lineTo(c.x,c.y);a.closePath()};return c}()})(window);
...
(function(h){var g=h.Sankaku,f=g.Shape;g.Tripod=function(){function e(c,b,a,k,d,e){f.call(this,c,b,a,k,d,e)}g.extend(f,e);var d=e.prototype;d.constructor=e;d.clone=function(){var c=new e(this.x,this.y,this.width,this.height,this._color,this._fill);c.rotation=this.rotation;c.scale=this.scale;c._alpha=this._alpha;c._rgb=Object.create(this._rgb);c._line=this._line;c._border={line:this._border.line,rgb:this._border.rgb};return c};d.paint=function(c){var b=this.bounding(),a=b.a,k=b.b,d=b.c,b=b.d;c.beginPath();
c.moveTo(a.x,a.y);c.lineTo(k.x,k.y+0.5*(d.y-k.y));c.lineTo(b.x,b.y);c.lineTo(a.x,a.y);c.closePath()};return e}()})(window);
...
rgb:this._border.rgb};return a};a.paint=function(a){var d=this._points,f=2*d,d=e.ONE_EIGHTY/d,g=e.NINETY,h=this.scale,v=this._radius*h,h=this._inner*h,r=this.x,s=this.y,p=this.rotation,t,u,w;a.beginPath();for(t=0;t<=f;++t)u=t*d-g+p,w=t%2?h:v,a.lineTo(r+w*b(u),s+w*c(u));a.closePath()};return d}()})(window);
...
(function(h){h.Sankaku.Zanzo=function(){function g(e){this._limit=e;this._objects=[]}var f=g.prototype;f.constructor=g;f.limit=function(e){this._limit=e};f.add=function(e){var d=this._objects,c=[],b,a;0<this._limit&&d.length>=this._limit&&d.shift();b=0;for(a=e.length;b<a;b++)d=e[b],c.push(d.clone());this._objects.push(c)};f.draw=function(e,d){var c=this._objects,b,a,f,g,h,l,m;h=c.length;f=1/(h+1);e.save();for(g=0;g<h;g++)for(b=c[g],a=f*(g+1),e.globalAlpha=a,l=0,m=b.length;l<m;l++)a=b[l],a.draw(e),

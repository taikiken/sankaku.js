...
(k.requestAnimationFrame=function(e){var d=Date.now(),c=Math.max(0,16-(d-h)),b=k.setTimeout(function(){e(d+c)},c);h=d+c;return b});void 0===k.cancelAnimationFrame&&void 0!==k.clearTimeout&&(k.cancelAnimationFrame=function(e){k.clearTimeout(e)});Object.create||(Object.create=function(){function e(){}return function(d){if(1!==arguments.length)throw Error("Object.create implementation only accepts one parameter.");e.prototype=d;return new e}}());Array.isArray||(Array.isArray=function(e){return"[object Array]"===
...
(function(k){k.Sankaku.Iro=function(){function h(){throw Error("Iro can't create instance");}h.rgb2hsl=function(f,g,e){f/=255;g/=255;e/=255;var d=Math.max(f,g,e),c=Math.min(f,g,e),b,a,q;a=(d+c)/2;if(d===c)b=c=0;else{q=d-c;c=0.5<a?q/(2-d-c):q/(d+c);switch(d){case f:b=(g-e)/q+(g<e?6:0);break;case g:b=(e-f)/q+2;break;case e:b=(f-g)/q+4}b/=6}return{h:b,s:c,l:a}};h.hsl2rgb=function(f,g,e){function d(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+(b-a)*(2/3-c)*6:a}if(0===g)e=g=
f=e;else{var c=0.5>e?e*(1+g):e+g-e*g,b=2*e-c;e=d(b,c,f+1/3);g=d(b,c,f);f=d(b,c,f-1/3)}return{r:255*e,g:255*g,b:255*f}};h.rgb2hsv=function(f,g,e){f/=255;g/=255;e/=255;var d=Math.max(f,g,e),c=Math.min(f,g,e),b,a=d-c;if(d===c)b=0;else{switch(d){case f:b=(g-e)/a+(g<e?6:0);break;case g:b=(e-f)/a+2;break;case e:b=(f-g)/a+4}b/=6}return{h:b,s:0===d?0:a/d,v:d}};h.hsv2rgb=function(f,g,e){var d,c,b,a=Math.floor(6*f),q=6*f-a;f=e*(1-g);var m=e*(1-q*g);g=e*(1-(1-q)*g);switch(a%6){case 0:d=e;c=g;b=f;break;case 1:d=
m;c=e;b=f;break;case 2:d=f;c=e;b=g;break;case 3:d=f;c=m;b=e;break;case 4:d=g;c=f;b=e;break;case 5:d=e,c=f,b=m}return{r:255*d,g:255*c,b:255*b}};h.hex2rgb=function(f){if("string"!==typeof f)return null;f=f.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(g,e,d,c){return e+e+d+d+c+c});return(f=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(f))?{r:parseInt(f[1],16),g:parseInt(f[2],16),b:parseInt(f[3],16)}:null};h.rgb2hex=function(f,g,e){function d(c){c=c.toString(16);return 1===c.length?"0"+c:c}
return"#"+d(f)+d(g)+d(e)};h.int2hex=function(f){f=Math.floor(f);f=f.toString(16);if(6>f.length)for(var g=6-f.length;g;)f="0"+f,--g;return"#"+f};return h}()})(window);
(function(k){k.Sankaku.List=function(){function h(){throw Error("List can't create instance");}var f=Math.random,g=Math.floor,e=Math.max;h.word=function(d,c){var b=[],a;for(a=0;a<d;a++)b[a]=c;return b};h.zero=function(d){return this.word(d,0)};h.shuffle=function(d){for(var c=[],b=d.length,a;b;)a=g(f()*d.length),a in d&&(c.push(d[a]),delete d[a],--b);return c};h.max=function(d){return e.apply(null,d)};return h}()})(window);
...
this.rotation,console.log("rotation ",a.rotation,this.rotation),n.scale=a.scale*this.scale,n.rotation=h);a=c(h);r=d(h);h=-f;k=-g;s=f;p=g;f=r*h;g=r*k;k*=a;h*=a;u=r*s;r*=p;s*=a;p*=a;a={x:f-k+b,y:g+h+e};g={x:u-k+b,y:g+s+e};k={x:u-p+b,y:r+s+e};b={x:f-p+b,y:r+h+e};n.x=0.5*(a.x+k.x);n.y=0.5*(a.y+k.y);return{a:a,b:g,c:k,d:b,e:n}};b.localBounding=function(){this.parent.bounding()};b.rotate=function(a){this.rotation=g.deg2rad(a)};b.clone=function(){return this._clone()};b._clone=function(){var a=new e;a.setPosition(this._position.clone());
a.width=this.width;a.height=this.height;a.rotation=this.rotation;a.scale=this.scale;a.parent=parent&&parent.clone();return a};b.inside=function(a){function b(a,c,d){return d.x*c.y-c.x*d.y-(d.x*a.y-a.x*d.y)+(c.x*a.y-a.x*c.y)}var c=this.bounding();return 0<b(c.a,a)||0<b(c.b,a)||0<b(c.c,a)?!1:!0};b.add=function(a){if(a!==this){a.parent&&a.parent.remove(a);a.parent=this;this.children.push(a);var b=this.scene;b&&b.addChild(a)}};b.remove=function(a){var b;b=this.children.indexOf(a);-1!==b&&(a.parent=null,
this.children.splice(b,1),(b=this.scene)&&b.removeChild(a))};b.draw=function(a){this._draw(a);var b=this.children,c,d,e;d=0;for(e=b.length;d<e;d++)c=b[d],c.visible&&0<c.alpha()&&b[d].draw(a)};b._draw=function(a){};b.swap=function(a,b){var c=this.children,d=c.indexOf(a),e=c.indexOf(b);c[e]=a;c[d]=b};b.highest=function(a){var b=this.children,c=b.indexOf(a);b.splice(c,1);b.push(a)};return e}()})(window);
...
this._line;a._border={line:this._border.line,rgb:this._border.rgb};return a};b.paint=function(a){var b=this.bounding().e,e=this._points,f=2*e,e=g.ONE_EIGHTY/e,h=g.NINETY,k=b.scale,v=this._radius*k,k=this._inner*k,n=b.x,s=b.y,b=b.rotation,p,r,u;a.beginPath();console.log("STAR",b);for(p=0;p<=f;++p)r=p*e-h+b,u=p%2?k:v,a.lineTo(n+u*c(r),s+u*d(r));a.closePath()};return e}()})(window);

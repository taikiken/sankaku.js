 ...
 * @type {string}
 */
Sankaku.build = "4/13/2015, 5:31:27 PM";
...
( function ( window ){
  ...
  Sankaku.Gasane = window.Gasane;
  Sankaku.EventDispatcher = Sankaku.Gasane.EventDispatcher;
...
( function ( window ){
    ...
    Sankaku.Bitmap = ( function (){
        ...
        function Bitmap ( x, y, width, height, img ) {
            ...
            var
              boundLoad = this.onLoad.bind( this ),
